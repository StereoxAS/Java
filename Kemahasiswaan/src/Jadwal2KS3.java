...
public class Jadwal2KS3 {
	...
	public Jadwal2KS3() {
		...
		//this.total=7;
		this.jadwal[0]= new JadwalParent("Senin ","1","242",matkul.getMatakuliah(0),dosen.getDosen(0));
		this.jadwal[1]= new JadwalParent("Senin ","2","325",matkul.getMatakuliah(2),dosen.getDosen(2));
		this.jadwal[2]= new JadwalParent("Selasa","1","323",matkul.getMatakuliah(6),dosen.getDosen(4));
		this.jadwal[3]= new JadwalParent("Selasa","3","254",matkul.getMatakuliah(4),dosen.getDosen(9));
