...
public class Jadwal2KS3 {
	...
	public Jadwal2KS3() {
		...
		//this.total=7;
		this.jadwal[0]= new PJadwal("Senin","Sesi1","242",matkul.getMatakuliah(0),dosen.getDosen(0));
		this.jadwal[1]= new PJadwal("Senin","Sesi2","325",matkul.getMatakuliah(2),dosen.getDosen(2));
		this.jadwal[2]= new PJadwal("Selasa","Sesi1","323",matkul.getMatakuliah(6),dosen.getDosen(4));
		this.jadwal[3]= new PJadwal("Selasa","Sesi3","254",matkul.getMatakuliah(4),dosen.getDosen(9));
		this.jadwal[4]= new PJadwal("Rabu","Sesi2","341",matkul.getMatakuliah(5),dosen.getDosen(7));
		this.jadwal[5]= new PJadwal("Kamis","Sesi1","265",matkul.getMatakuliah(1),dosen.getDosen(5));
		this.jadwal[6]= new PJadwal("Kamis","Sesi2","344",matkul.getMatakuliah(3),dosen.getDosen(10));
	}
